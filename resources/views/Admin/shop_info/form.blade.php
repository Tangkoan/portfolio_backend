...
<div class="min-h-screen py-8 " x-data="shopForm({{ json_encode($shop) }})">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form @submit.prevent="submitForm" class="relative">
            ...
            {{-- Loading Overlay --}}
            {{-- Update: dark:bg-gray-900/50 និង spinner box dark:bg-gray-800 --}}
            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
                ...
                <div class="xl:col-span-8 space-y-8">
                    ...
                    {{-- Update: bg-white -> dark:bg-gray-800, border-gray-100 -> dark:border-gray-700 --}}
                    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden group hover:shadow-md transition-all duration-300">
                        ...
                        {{-- Card Header --}}
                        {{-- Update: bg-gray-50/30 -> dark:bg-gray-700/30, border-gray-100 -> dark:border-gray-700 --}}
                        <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/30 dark:bg-gray-700/30 flex items-center justify-between">
                            {{-- Update: text-gray-800 -> dark:text-white --}}
                            <h3 class="text-lg font-bold text-gray-800 dark:text-white flex items-center gap-2">
                                <img src="https://flagcdn.com/w40/us.png" class="w-6 h-6 rounded-full shadow-sm object-cover">
                                English Details
                            </h3>
                            <span class="text-xs font-medium px-2 py-1 bg-gray-100 dark:bg-gray-700 rounded text-gray-500 dark:text-gray-300">Default</span>
                        </div>
                        
                        <div class="p-6 space-y-6">
                            {{-- Shop Name Input --}}
                            <div>
                                {{-- Update: text-gray-700 -> dark:text-gray-300 --}}
                                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Shop Name <span class="text-red-500">*</span></label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400">
                                        <i class="ri-store-2-line"></i>
                                    </div>
                                    {{-- Update: bg-gray-50/50 -> dark:bg-gray-900, text-gray-700 -> dark:text-gray-200, border-gray-200 -> dark:border-gray-600, focus:bg-white -> dark:focus:bg-gray-800 --}}
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden group hover:shadow-md transition-all duration-300">
                         <div class="px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/30 dark:bg-gray-700/30 flex items-center justify-between">
                            ...
                            <span class="text-xs font-medium px-2 py-1 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded">Local</span>
                        </div>

                        <div class="p-6 space-y-6">
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">ឈ្មោះហាង (KH)</label>
                                <div class="relative">
                                    <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-gray-400">
                                        <i class="ri-store-2-line"></i>
                                    </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div class="col-span-1 md:col-span-2">
                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">អាសយដ្ឋាន (KH)</label>
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">អំពីហាង (KH)</label>
                                ...
                                <div>
                                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">សម្គាល់ (KH)</label>
                ...
                <div class="xl:col-span-4 space-y-8">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 hover:shadow-md transition-all duration-300">
                        ...
                        <div class="space-y-5">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700/50 rounded-2xl p-4 border border-gray-100 dark:border-gray-600">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400" x-text="form.status == 1 ? 'Your shop is currently Visible to public.' : 'Your shop is Hidden from public.'"></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 hover:shadow-md transition-all duration-300">
                        ...
                        <div class="mb-6">
                            <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Main Logo</label>
                            {{-- Update: bg-gray-50 -> dark:bg-gray-900, border-gray-300 -> dark:border-gray-600 --}}
                            ...
                            <p class="text-xs text-center text-gray-400 dark:text-gray-500 mt-2">Recommended: 500x500px .PNG</p>
                        </div>
                        ...
                        <div class="border-t border-gray-100 dark:border-gray-700 pt-5">
                            <div class="flex items-start gap-4">
                                ...
                                <div>
                                    <label class="block text-sm font-bold text-gray-700 dark:text-gray-300">Favicon</label>
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1 leading-relaxed">Small icon shown in browser tabs.</p>
                                </div>
                            </div>
                        </div>
