        ...
        <table class="w-full text-left border-collapse">
            <thead>
                <tr class="bg-page-bg/50 border-b border-border-color text-text-color text-sm uppercase tracking-wider">
                    ...
                    <th class="px-6 py-4 font-bold w-24" x-show="showCols.image">Image</th>
                    <th class="px-6 py-4 font-bold cursor-pointer hover:text-primary transition-colors" @click="sort('name')">
                        <div class="flex items-center gap-1">Tool Name <span x-show="sortBy === 'name'" class="text-primary"><i x-show="sortDir === 'asc'" class="ri-arrow-up-line"></i><i x-show="sortDir === 'desc'" class="ri-arrow-down-line"></i></span></div>
                    </th>
                    <th class="px-6 py-4 font-bold w-32" x-show="showCols.status">Status</th>
            ...
            <tbody class="divide-y divide-border-color">
                ...
                <tr x-show="tools.length === 0">
                    <td colspan="5" class="px-6 py-12 text-center text-secondary"><i class="ri-tools-line text-4xl mb-2 inline-block"></i><p>No tools found</p></td>
                </tr>
            </tbody>
        </table>
    </div>
